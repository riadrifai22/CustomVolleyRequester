 ...
 */
public abstract class AbstractEzVolleyRequest<FinalResponse, IntermediateResponse> extends
        Request<FinalResponse> {

    protected final Gson gson = new Gson(); //todo create singleton gson instance

    protected NetworkResponseHandler<FinalResponse> networkResponseHandler;

    private BaseEzFields<FinalResponse, IntermediateResponse> volleyRequestFields;
     ...
     */
    public AbstractEzVolleyRequest(final BaseEzFields<FinalResponse, IntermediateResponse> volleyFields,
     ...
     */
    protected BaseEzFields<FinalResponse, IntermediateResponse> getVolleyRequestFields() {
        return volleyRequestFields;
    }

    protected NetworkResponseHandler<FinalResponse> getNetworkResponseHandler(){
    ...
    /**
     * By default, this returns the headers added to {@link BaseEzFields#headersToAdd}
     * If you need default headers, inherit from {@link AbstractEzVolleyRequest} and override this method.
